...
// IIFE
// Una función IIFE es una función que se ejecuta inmediatamente, 
// por lo tanto no es necesario esperar a que un evento ocurra, 
// se ejecuta una vez que se define, es decir una vez que das clic en el botón, 
// la función se define y ejecuta
...
(function() {
    ...
    function mostrarTareas(){
        ...
        arrayTareas.forEach(tarea => {
            ...
            btnEstadoTarea.ondblclick = function(){
                // CREANDO UNA COPIA DEL ARREGLO PARA NO MODIFICAR EL ARREGLO ORIGINAL AUN
    ...
    function mostrarFormulario(editar = false, tarea = {}){
        ...
        modal.innerHTML =  `
            <form class="formulario nueva-tarea">
                ...
                <div class="campo">
                    <label>Tarea</label>
                    <input type="text" value="${tarea.nombre ? tarea.nombre : ''}" name="tarea" placeholder="${tarea.nombre ? 'Edita la Tarea' : 'Añadir Tarea al proyecto Actual'}" id="tarea"/>
                </div>
                <div class="opciones">
    ...
    function limpiarTareas(){
        ...
        // ES MAS RAPIDO PONER EL WHILE QUE EL INNERHTML = "" VACIO
